<x-layout>
    ...
    <ul>
        <li>Purchase Price: UPB - (UPB * %)</li>
        <li>10%: {{ $note->scenarios }}</li>
        <li>10%: {{ $note->getRawOriginal('upb_initial') - ($note->getRawOriginal('upb_initial') * .10) }}</li>
        <li>15%: {{ $note->getRawOriginal('upb_initial') - ($note->getRawOriginal('upb_initial') * .15) }}</li>
        <li>20%: {{ $note->getRawOriginal('upb_initial') - ($note->getRawOriginal('upb_initial') * .20) }}</li>
    </ul>
